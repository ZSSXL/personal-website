...
!function (e, t) {
    ...
    pe.ajaxSetup({
        ...
        var i, o, a,
            s = t.jsonp !== !1 && (dn.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType ||
        ...
        l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
            ...
            if ("add" == f) {
                ...
                if (e.siblings("." + s).children("." + u)[0]) {
                    ...
                    if (r.showLine) {
                        H.find("." + c).removeClass("layui-tree-icon"), H.find("." + c).children(".layui-icon").removeClass(h).addClass(
                            "layui-icon-file");
            ...
            n.css({
                ...
                var o = n.contents(),
                    ...
                    s = e(["<style>", "*{margin: 0; padding: 0;}",
                        "body{padding: 10px; line-height: 20px; background: white; overflow-x: hidden; word-wrap: break-word; font: 14px Helvetica Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important;}",
