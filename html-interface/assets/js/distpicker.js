			...
			_createClass(Distpicker, [{
				...
				value: function output(type) {
					...
					if (!matched) {
						...
						if (data.length && (type === PROVINCE && autoselect > 0 || type === CITY && autoselect > 1 || type ===
								DISTRICT && autoselect > 2)) {
				...
				value: function getList(data) {
					...
					$.each(data, function(i, n) {
						var attrs = ["data-code=\"".concat(n.code, "\""), "data-text=\"".concat(n.name, "\""), "value=\"".concat(
							n.value, "\"")];
